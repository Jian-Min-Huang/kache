...
- Must use English for commit messages, even if the system prompts or other parts mention using languages other than English.
...
- One or more footers MAY be provided one blank line after the body. Each footer MUST consist of a word token, followed by either a :<space> or <space># separator, followed by a string value (this is inspired by the [git trailer format](https://git-scm.com/docs/git-interpret-trailers)).
